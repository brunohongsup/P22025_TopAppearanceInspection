...
// Constructor
//
CDlgViewChart::CDlgViewChart(CWnd* pParent /*=NULL*/)
    : CDialog(CDlgViewChart::IDD, pParent)
{
...
/////////////////////////////////////////////////////////////////////////////
// CDlgViewChart message handlers
...
HCURSOR CDlgViewChart::OnQueryDragIcon()
{
...
//
void CDlgViewChart::OnPointerPB() 
{
...
//
void CDlgViewChart::OnZoomOutPB() 
{
...
//
void CDlgViewChart::OnViewPortChanged()
{
...
//
void CDlgViewChart::OnStartDateChanged(NMHDR* pNMHDR, LRESULT* pResult) 
{
...
//
void CDlgViewChart::OnEndDateChanged(NMHDR* pNMHDR, LRESULT* pResult) 
{
    // Get the selected date
    SYSTEMTIME t;
    m_EndDate.GetTime(&t);
...
//
void CDlgViewChart::OnHScroll(UINT nSBCode, UINT nPos, CScrollBar* pScrollBar) 
{
...
//
BOOL CDlgViewChart::OnMouseWheel(UINT nFlags, short zDelta, CPoint pt)
{
...
//
void CDlgViewChart::OnMouseMovePlotArea()
{
...
/////////////////////////////////////////////////////////////////////////////
// CDlgViewChart methods

//
// Load the data
//
void CDlgViewChart::loadData()
{
...
// Initialize the CChartViewer 
//
void CDlgViewChart::initChartViewer(CChartViewer *viewer)
{
...
// Initialize the CChartViewer 
//
void CDlgViewChart::updateControls(CChartViewer *viewer)
{
...
//
double CDlgViewChart::moveScrollBar(UINT nSBCode, UINT nPos, CScrollBar* pScrollBar)
{
    //
...
//
void CDlgViewChart::drawChart(CChartViewer *viewer)
{
...
//
void CDlgViewChart::trackLineLabel(XYChart *c, int mouseX)
{
...
//
void CDlgViewChart::loadButtonIcon(int buttonId, int iconId, int width, int height)
{
