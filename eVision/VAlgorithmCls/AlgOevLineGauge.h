...
namespace Euresys { namespace Open_eVision_1_2 { class ELineGauge; } }

class CAlgOevLineGauge : public CAlgOevBase
{
public:
	CAlgOevLineGauge(void);
	virtual ~CAlgOevLineGauge(void);


	ELineGauge* GetLineGaugeInstance() { return m_pLineGauge; }
