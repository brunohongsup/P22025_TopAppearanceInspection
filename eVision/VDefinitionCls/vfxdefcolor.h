...
// RGB 매크로 쓸때 줄맞춤을 위해서 비는 자리를 0으로 채우지 말것
// 예를들어 76 이라고 치면 076 이라고 쓰지 말 것. 스페이스로 메꿀 것 20120620 jhsong

// Color ///////////////////////////////////////////////////////
#define			BLACK				RGB(   0,   0,   0 )
#define			WHITE				RGB( 255, 255, 255 )
#define			TRANSPARENCY		RGB( 125, 127, 126 )

#define			DARKGRAY			RGB(  64,  64,  64 )
#define			DARKSLATEGRAY		RGB(  40,  79,  79 )
#define			DEEPDARKGRAY		RGB(  50,  50,  50 )
#define			GLOOMYGRAY			RGB(  85,  85,  85 )
#define			GRAY				RGB( 128, 128, 128 )
#define			LIGHTGRAY			RGB( 169, 169, 169 )
...
#define			DEEPRED				RGB( 225,   0,  77 )
#define			INDIANRED			RGB( 205,  92,  92 )
#define			MEDIUMVIOLETRED		RGB( 199,  21, 112 )
...
#define			DARKORANGE			RGB( 200, 120,   0 )
#define			ORANGE				RGB( 255, 165,   0 )

#define			OLIVE				RGB( 128, 128,   0 )
#define			OLIVEDRAB			RGB( 107, 142,  45 )
...
#define			DARSALMON			RGB( 233, 150, 122 )
#define			FIREBRICK			RGB( 178,  34,  34 )

#define			LIGHTORANGE			RGB( 248, 241, 231 )
